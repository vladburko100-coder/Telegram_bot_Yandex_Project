...
def get_secret_country():
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "Загадай не сложную случайную страну мира. Напиши только название страны на русском языке."
                           "НЕ ПОВТОРЯЙ СТРАНЫ ИЗ ПРОШЛЫХ ЗАПРОСОВ, НУЖНО РАЗНОБРАЗИЕ!"
            },
        ],
    )
